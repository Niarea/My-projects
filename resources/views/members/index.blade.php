              ...
              <tbody>
                @foreach($members as $member)
                  ...
                  <tr>
                    ...
                    <td class="px-4 py-3"><a href="{{ route('members.show', $member->id) }}" role="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Voir</a></td>
                    <td class=" px-4 py-3"><a href="{{ route('members.edit', $member->id) }}" role="button" class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">Modifier</a></td>
                      <td class=" px-4 py-3">
